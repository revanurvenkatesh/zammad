...
ActiveRecord::Schema.define(version: 2019_10_24_235233) do
  ...
  create_table "groups_macros", id: false, force: :cascade do |t|
  ...
  create_table "groups_text_modules", id: false, force: :cascade do |t|
  ...
  create_table "knowledge_base_answer_translation_contents", id: :serial, force: :cascade do |t|
    t.text "body"
  end

  create_table "knowledge_base_answer_translations", id: :serial, force: :cascade do |t|
  ...
  create_table "knowledge_base_answers", id: :serial, force: :cascade do |t|
    t.integer "category_id", null: false
    t.boolean "promoted", default: false, null: false
    t.text "internal_note"
    t.integer "position", null: false
    t.datetime "archived_at", precision: 3
    t.integer "archived_by_id"
    t.datetime "internal_at", precision: 3
    t.integer "internal_by_id"
    t.datetime "published_at", precision: 3
  ...
  create_table "knowledge_base_categories", id: :serial, force: :cascade do |t|
  ...
  create_table "knowledge_base_category_translations", id: :serial, force: :cascade do |t|
    t.string "title", limit: 250, null: false
    t.integer "kb_locale_id", null: false
    t.integer "category_id", null: false
    t.datetime "created_at", null: false
  ...
  create_table "knowledge_base_locales", id: :serial, force: :cascade do |t|
    t.integer "knowledge_base_id", null: false
  ...
  create_table "knowledge_base_menu_items", id: :serial, force: :cascade do |t|
    t.integer "kb_locale_id", null: false
    t.integer "position", null: false
  ...
  create_table "knowledge_base_translations", id: :serial, force: :cascade do |t|
    t.string "title", limit: 250, null: false
  ...
  create_table "knowledge_bases", id: :serial, force: :cascade do |t|
