class App.Ticket extends App.Model
  @configure 'Ticket', 'number', 'title', 'group_id', 'owner_id', 'customer_id', 'state_id', 'priority_id', 'are_you_victim', 'anonymous','victim', 'where', 'when_it_happend', 'article', 'others', 'happening_now', 'tags', 'links', 'updated_at', 'preferences'
  ...
  @configure_attributes = [
      ...
      { name: 'are_you_victim',           display: 'are_you_victim', tag:'select', type:'checkbox', limit:100, null: true },
      ...
      { name: 'happening_now',            display: 'ongoing', tag:'input', type:'text', limit:100, null: true },
      { name: 'when_it_happend',          display: 'when',  tag:'datetime', null: true, readonly: 1, width: '110px' },
      { name: 'where',                    display: 'where', tag:"input", type:'text' , limit: 100, null: false  },
      { name:'anonymous',                display: 'anonymous', tag:"select", type:'checkbox' , limit: 100, null: true  },
    ]
